...
TransferUnet.float()
# checkpoint = torch.load("/home/sehajs/mvimgnet_3_classes/ckpt/transfer_unet_750")
...
# Your classes
classes = ['6','8','36']
save_dir = "/home/sehajs/mvimgnet_3_classes/results_test_set_650_ckpt"
...
checkpoint = torch.load("/home/sehajs/mvimgnet_3_classes/ckpt/transfer_unet_650")
TransferUnet.load_state_dict(checkpoint['model_state_dict'])
print(TransferUnet)
...
with torch.no_grad():
# Initialize the progress bar for training
    with tqdm(enumerate(inverted_latent_camera_dl_test), total=len(inverted_latent_camera_dl_test), desc=f"Testing", unit="batch") as tepoch:
        for step, batch in tepoch:
            xb_path,yb_path,xb, yb,cam_data1,cam_data2,class_data,input_rays,target_rays = batch
            batch_size = len(batch[0])
            yb,cam_data1,cam_data2 = yb.cuda(),cam_data1.cuda(),cam_data2.cuda()
